# TDAP Orchestration Report — r=3 factorization audit and packaging

- created_utc: `20260513T160324Z`
...
Matplotlib created a temporary cache directory at /tmp/matplotlib-jywvqfcv because there was an issue with the default path (/home/leah/.config/matplotlib); it is highly recommended to set the MPLCONFIGDIR environment variable to a writable directory, in particular to speed up the import of Matplotlib and to better support multiprocessing.
