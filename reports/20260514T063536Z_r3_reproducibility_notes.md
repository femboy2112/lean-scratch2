...
scripts/r3_deep_program_reproduce.sh reruns Python checks, exact gcd, exact residual/relation expansion, deep-program report generation, and witness collection with local Sage.
