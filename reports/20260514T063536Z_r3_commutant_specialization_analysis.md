# r3 commutant specialization analysis
...
Generic commutant solving over QQ(t) and exact specialization projector search are deferred to a focused Sage/linear-algebra pass.
