# r2 r3 factor structure comparison
...
This comparison does not establish cross-level invariance. r=2 mechanisms do not transfer to r=3 without independent r=3 witness.
