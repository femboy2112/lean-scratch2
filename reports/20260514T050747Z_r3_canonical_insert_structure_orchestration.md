# TDAP Orchestration Report — r=3 canonical insertion patch and factor-structure analysis

- created_utc: `20260514T050747Z`
...
Matplotlib created a temporary cache directory at /tmp/matplotlib-vosssbac because there was an issue with the default path (/home/leah/.config/matplotlib); it is highly recommended to set the MPLCONFIGDIR environment variable to a writable directory, in particular to speed up the import of Matplotlib and to better support multiprocessing.
